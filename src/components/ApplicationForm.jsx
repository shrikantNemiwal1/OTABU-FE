    ...
    onSubmit: async (values) => {
      ...
      try {
        const response = await axios.post(
          BASE_URL + `/api/application_form/create/${id}`,
          values,
          config
        );
    ...
    <div className="registration">
      ...
      <form onSubmit={handleSubmit}>
        <div className="registration__form">
          ...
          <div className="input__container">
            <div className="input__error-container">
              {(errors.CertificationScheme || touched.CertificationScheme) && (
                <p className="input__error">{errors.CertificationScheme}</p>
              )}
            </div>
          </div>
          ...
          <h2 className="form-sub-title">
            If Integrated Certification need than please answer below questions?
          </h2>

          <>
            {Object.keys(IntegratedCertiYesNoInputs).map((key) => (
              <div className="input__container checkbox-container" key={key}>
            ...
            <div className="input__container checkbox-container">
              <label>
                Please confirm the preferred language for the conduct of the
                audit :
              </label>
              <label className="checkbox-label">
                <input
              ...
              <label className="checkbox-label">
                <input
                  ...
                  name="IntegratedCerti.conduct_language"
                  value="Hindi"
                  checked={values.IntegratedCerti.conduct_language === "Hindi"}
                  onChange={handleChange}
                  onBlur={handleBlur}
                />
                <p>Hindi</p>
              ...
              <label className="checkbox-label">
                <input
                  ...
                  name="IntegratedCerti.conduct_language"
                  value="Both"
                  checked={values.IntegratedCerti.conduct_language === "Both"}
                  onChange={handleChange}
                  onBlur={handleBlur}
                />
                <p>Both</p>
            ...
            <div className="input__container checkbox-container">
              ...
              <label className="checkbox-label">
                <input
                  ...
                  value="Surveillance"
                  checked={
                    values.IntegratedCerti.certi_program_req === "Surveillance"
                  }
                  onChange={handleChange}
                  onBlur={handleBlur}
                />
              ...
              <label className="checkbox-label">
                <input
                  ...
                  value="Transfer"
                  checked={
                    values.IntegratedCerti.certi_program_req === "Transfer"
                  }
                  onChange={handleChange}
                  onBlur={handleBlur}
                />
            ...
            <div className="input__container checkbox-container">
              <label>
                In the case of several certification programmes, would you like
                the audits to be Combined or carried out separately?
              </label>
              <label className="checkbox-label">
                <input
                  type="radio"
                  ...
                  value="Yes"
                  checked={values.IntegratedCerti.combined_audit === "Yes"}
                  onChange={handleChange}
                  onBlur={handleBlur}
                />
                <p>Yes</p>
            ...
            <div className="input__container checkbox-container">
              ...
              <label className="checkbox-label">
                <input
                  ...
                  value="Yes"
                  checked={
                    values.IntegratedCerti.already_certi_standard === "Yes"
                  }
                  onChange={handleChange}
                  onBlur={handleBlur}
                />
          ...
          <div className="input__container">
            <label htmlFor="EMS.sig_environ_sum">
              Please summarise the significant Environmental Aspects that you
              have identified :
            </label>
            <input
              type="text"
            ...
            />
            <div className="input__error-container">
              {errors.EMS?.sig_environ_sum && touched.EMS?.sig_environ_sum ? (
                <p className="input__error">{errors.EMS.sig_environ_sum}</p>
              ) : null}
            </div>
          </div>
          ...
          <div className="input__container">
            <label htmlFor="EMS.environ_legal_req">
              Please detail any Environmental legal requirements related to your
              company activity :
            </label>
            <input
              type="text"
            ...
            <div className="input__error-container">
              ...
              touched.EMS?.environ_legal_req ? (
                <p className="input__error">{errors.EMS.environ_legal_req}</p>
              ) : null}
            </div>
          </div>
          ...
          {Object.keys(OHSASInputs).map((key) => (
            <div className="input__container" key={key}>
              <label htmlFor={`OHSAS.${key}`}>{`${OHSASInputs[key]}`}</label>
              <input
                type="text"
                name={`OHSAS.${key}`}
                id={`OHSAS.${key}`}
          ...
          <div className="input__container">
            <label htmlFor="">
              Please provide accident statistics for last two years and current
              year to date:
            </label>
            <table className="table-form">
              <thead>
                      ...
                      <td key={`${rowKey + columnKey}`}>
                        ...
                        {touched?.OHSAS?.[rowKey + columnKey] &&
                          errors?.OHSAS?.[rowKey + columnKey] && (
                            <div>{errors?.OHSAS?.[rowKey + columnKey]}</div>
                          )}
                      </td>
                    ))}
                  </tr>
          ...
          <div className="input__container checkbox-container">
            <label>ISMS Documented and Implemented System available?</label>
            <label className="checkbox-label">
              <input
                type="radio"
          ...
          <div className="input__container checkbox-container">
            ...
            <div className="input__error-container">
              {errors.ISO37001?.abms_risk || touched.ISO37001?.abms_risk ? (
                <p className="input__error">{errors.ISO37001?.abms_risk}</p>
              ) : null}
            </div>
          </div>
          ...
          <h3 className="form-sub-title">
            ...
            knowledge and belief and I am authorized to provide such information
          ...
          <div className="input__container">
            ...
            <div className="input__error-container">
              ...
              touched.OtabuOffUse?.name_otabu ? (
                <p className="input__error">{errors.OtabuOffUse.name_otabu}</p>
              ) : null}
            </div>
          </div>
          ...
          <div className="input__container">
            ...
            <div className="input__error-container">
              ...
              touched.OtabuOffUse?.sign_otabu ? (
                <p className="input__error">{errors.OtabuOffUse.sign_otabu}</p>
              ) : null}
            </div>
          </div>
          ...
          <div className="input__container checkbox-container">
            <label>Can the Application Proceed for Application Review?</label>
            <label className="checkbox-label">
              <input
                type="radio"
          ...
          <div className="input__container">
            <label htmlFor="OtabuOffUse.name_officer">Name of Officer :</label>
            <input
              type="text"
